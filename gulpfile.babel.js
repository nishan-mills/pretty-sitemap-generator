...
* @see https://github.com/backflip/gulp-iconfont-css for config options
*/
gulp.task('iconfont', function() {
  return gulp.src(`${source}/img/icons/*.svg`)
  .pipe($.iconfontCss({
    fontName: 'icons',
    path: `${source}/icon-generator/_icons.scss`,
...
gulp.task('default', function() {
  sync.init({
    proxy: 'http://localhost/pretty-sitemap-generator/',
    port: 3001,
    ghostMode: {
      scroll: true,
    },
